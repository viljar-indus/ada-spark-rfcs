...
unit, the last one to apply decides the mode of that unit, the way the pragmas
...
apply to a compilation unit, in which case the last one to apply decides the
